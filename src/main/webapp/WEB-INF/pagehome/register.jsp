...
<div data-v-676ecf83="" id="app">
    <div data-v-95c8bc32="" data-v-676ecf83="" class="header2">
        <div data-v-95c8bc32="" class="layout clear">
            <div data-v-95c8bc32="" class="left logo">
                <a data-v-95c8bc32="" href="${pageContext.request.contextPath}/view/index">
                    <img data-v-95c8bc32=""
            ...
            <a data-v-95c8bc32="" href="${pageContext.request.contextPath}/view/index" class="right">回到首页&gt;</a>
        </div>
    </div>
            ...
            <div data-v-676ecf83="" class="registerCom clear">
                <div data-v-676ecf83="" class="registerType left">
                    ...
                    <form class="layui-form" method="post">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="tel" name="tel" lay-verify="required|phone" placeholder="请输入手机号"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="password" lay-verify="password" placeholder="请再次输入密码"
                                           autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" id="email" name="email" lay-verify="email"
                                           placeholder="请输入电子邮箱，用于登录和找回密码"
                                           autocomplete="off" class="layui-input">
                                    <input type="button" id="send" onclick="sendEmail()" value="免费获取验证码">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" name="invitation" lay-verify="invitation" autocomplete="off"
                                           placeholder="请输入您的验证码" class="layui-input">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <button class="layui-btn" lay-submit="" lay-filter="demo1" onclick="validateTel()">立即提交</button>
                            </div>
                        </div>
                ...
                <div data-v-676ecf83="" class="registerImg right">
                    <h2 data-v-676ecf83="">已有车速递账号？
                        <a data-v-676ecf83=""
                           href="${pageContext.request.contextPath}/view/login">立即登录&nbsp;&gt;&gt;</a>
    ...
    <div data-v-3aaf9db2="" data-v-676ecf83="" class="footer2">
        <div data-v-3aaf9db2="" class="layout clear">
            <div data-v-3aaf9db2="" class="d1"><a data-v-3aaf9db2="" href="about.html">关于车速递</a>|<a data-v-3aaf9db2=""
                                                                                                    target="_blank"
                                                                                                    href="http://search.51job.com/list/co,c,2264765,0000,10,1.html">诚聘英才</a>|<a
                    data-v-3aaf9db2="" href="about.html">联系我们</a>|<a data-v-3aaf9db2="" href="helpCenter.html">帮助中心</a>
            </div>
