                        ...
                        <form class="layui-form" method="post">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="tel" required  lay-verify="required" value="123456" placeholder="请输入手机号" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div data-v-0a99943a="" class="goRegister">
                                还没有账号？<a data-v-0a99943a="" href="${pageContext.request.contextPath}/view/register">免费注册</a></div>
                        </form>
                    </div>
                </div>
            </div>
        ...
        form.on('submit(formDemo)', function(msg){
            $.ajax({
                ...
                success:function(obj) {
                    console.log(obj);
                    if(obj == "1") {
                        window.location.href="${pageContext.request.contextPath}/user/loginSuccess";
                    }else {
                        alert("账号或者密码错误");
                    }
                },
