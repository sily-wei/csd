...
<head>
    ...
    <script type="application/javascript" src="${pageContext.request.contextPath}/resources/js/jquery-3.3.1.js"></script>
    ...
    <div data-v-95ac8d30="" class="header3">
        <div data-v-95ac8d30="" class="layout clear">
            <div data-v-95ac8d30="" class="left logo">
                <a data-v-95ac8d30="" href="${pageContext.request.contextPath}/view/index">
            ...
            </div> <div data-v-95ac8d30="" class="header3Nav right">|<a data-v-95ac8d30="" href="${pageContext.request.contextPath}/view/myMain">我的订单</a>|<a data-v-95ac8d30="" href="helpCenter.html">帮助中心</a>|<a data-v-95ac8d30="" href="javascript:void">退出</a>
        </div>
                ...
                <div class="userInfoL left">
                    <div data-v-1cae2c34="" class="userNav">
                        ...
                        <ul data-v-1cae2c34="" class="manNav">
                            <li data-v-1cae2c34="">
                                <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/view/myMain" class="sel">订单管理</a>
                            </li>
                             <li data-v-1cae2c34="">
                                 <a data-v-1cae2c34="" href="${pageContext.request.contextPath}/view/user" class="">个人信息</a>
                             </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="orderListCom listCom" style="position: static;">
                                <table cellspacing="0" cellpadding="0">
                                    <tr class="firstTr">
                                        ...
                                        <th>订单金额</th>
                                        <th>车型</th>
                                        <th style=" white-space:nowrap;overflow: hidden;width: 20%">取车地址</th>
                                        <th style=" white-space:nowrap;overflow: hidden;width: 20%">还车地址</th>
                                        <th>订单状态</th>
                                        <th>操作</th>
                                    </tr>
                                </table>
                                <div class="noData" id="noda">
                                    ...
                                    <table cellspacing="0" cellpadding="0">
                                        <tr class="firstTr" v-for="site in obj">
                                            ...
                                            <td>{{site.oprice}}</td>
                                            <td>{{site.cname}}</td>
                                            <td style=" white-space:nowrap;overflow: hidden;width: 20%">{{site.getcity}}</td>
                                            <td style=" white-space:nowrap;overflow: hidden; width: 20%">{{site.backcity}}</td>
                                            <td>{{site.ostatus}}</td>
                                            <td><a href="#" style="color:red" id="delete">删除</a></td>
                                        </tr>
                                    </table>
                                    <div id="fenye"></div>
                                </div>
    ...
    <div data-v-3aaf9db2="" class="footer2">
        <div data-v-3aaf9db2="" class="layout clear">
            <div data-v-3aaf9db2="" class="d1">
                <a data-v-3aaf9db2="" href="${pageContext.request.contextPath}/view/about">关于车速递</a></div></div></div>
   </div>
...
<script type="text/javascript">
    ...
    function loadData(page) {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/order/all?page="+page,
            dataType:"json",
            async: false,
