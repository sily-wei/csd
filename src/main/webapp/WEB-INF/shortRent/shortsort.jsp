    ...
    <div data-v-67ef3a4a class="layout clear">
        <div data-v-67ef3a4a class="left csdnav">
            <c:if test="${empty sessionScope.USERNAME}">
                <label data-v-67ef3a4a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/view/login" class="colorRed">登录</a>
            ...
            <c:if test="${not empty sessionScope.USERNAME}">
                <label data-v-67ef3a4a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/view/user">你好，${sessionScope.USERNAME}</a>
                    <a data-v-67ef3a4a href="#" class="colorRed">/</a>
                    <a data-v-67ef3a4a href="${pageContext.request.contextPath}/view/quit" class="colorRed" style="margin-right: 10px;">[退出]</a>
                </label>
            </c:if>
        ...
        <div data-v-67ef3a4a="" class="right phone">
            <div data-v-67ef3a4a="" class="typeTab">
                <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/view/index" style="color: rgb(199, 0, 11);">中文</a>&nbsp;/&nbsp;
                <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/view/index">English</a>
            </div>
            <div data-v-67ef3a4a="" class="menu">
                <a data-v-67ef3a4a="" href="${pageContext.request.contextPath}/view/myMain">我的车速递</a>
            </div>
            <div data-v-67ef3a4a="">
...
<div data-v-39f7f629 class="csdnav">
    <div data-v-39f7f629="" class="layout clear">
        <div data-v-39f7f629="" class="left logo">
            <a data-v-39f7f629="" href="${pageContext.request.contextPath}/view/index">
                <img data-v-39f7f629=""
        ...
        <div data-v-39f7f629="" class="left navCom">
            <ul data-v-39f7f629="">
                ...
                <li data-v-39f7f629="">
                    <a data-v-39f7f629="" href="${pageContext.request.contextPath}/view/index" target="_self">
    ...
    var vm2 = new Vue({
        ...
        methods: {
            selectCar: function (id) {
                window.location.href = "${pageContext.request.contextPath}/view/order" + getid + "&cid=" + id;
            }
        },
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "get",
            url: "${pageContext.request.contextPath}/car/list" + getid,
            dataType: "json",
            success: function (data) {
                if (data.code == 1) {
                    var get = data.info.name;
                    var back = data.info2.name;
                    vm.getcitys = get;
                    vm.backcitys = back;
                }
            },
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "get",
            url: "${pageContext.request.contextPath}/car/carList" + getid,
            dataType: "json",
            success: function (data) {
                if (data.code == 1) {
                    vm3.cars = data.info;
